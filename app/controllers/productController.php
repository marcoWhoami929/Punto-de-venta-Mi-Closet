...
*/
	...
	/***************MODULO DE REPORTEADORES */
	public function reporteKardexxControlador($datos)
	{
		/*=============================================
		...
		$arregloHeaders = ['Producto', 'Codigo Producto', 'Entradas', 'Salidas', 'Existencias', 'Stock Minimo', 'Stock Maximo'];
		...
		echo "<tr>
						...
						<tr>
						<th colspan='7' style='font-weight:bold; background:#17202A; color:white;'>R E P O R T E &nbsp; D E &nbsp;K A R D E X &nbsp</th>
						</tr>
		...
		foreach ($datos as $key => $value) {
			...
			echo utf8_decode("<tr>
											...
											<td style='" . $style . "'>" . $codigoProducto . "</td>
											 <td style='color:black;'>" . $value["entradas"] . "</td>
											 <td style='color:black;'>" .   $value["salidas"] . "</td>
											 <td style='color:black;'>" .  $value["existencias"]  . "</td>
											  <td style='color:black;'>" .  $value["stock_minimo"]  . "</td>
											   <td style='color:black;'>" .  $value["stock_maximo"]  . "</td>
	...
	public function reporteKardexControlador($datos)
	{
		...
		require_once "/app/phpexcel/Classes/PHPExcel/PHPExcel.php";
